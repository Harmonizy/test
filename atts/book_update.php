	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				<img src="images/bannerr.jpg" class="img-fluid" alt="Responsive image">
			</div>
		</div>
					...
					<form class="container" action="update_book.php" method="post" id="needs-validation" novalidate enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-12 mb-3">
								...
								<input type="text" class="form-control" id="validationCustom06" placeholder="หมวดหมู่" name="book_group"  value="<?=$book->book_group?>" required>
								<div class="invalid-feedback">
									กรุณาระบุหมวดหมู่.
								</div>
							</div>
                       ...
                       <?php if($book->book_detail != ''){?>
						<div class="row">
							<div class="col-md-12 mb-3">
								...
								<a href="<?=$book->book_detail?>"><p>ดูเอกสาร</p></a>
							</div>
						</div>	
						<?php }?>
						...
						<div class="row">
							<div class="col-md-12 mb-3">
								<label for="validationCustom06">อัปเอกสารใหม่</label>
...
function checkDelete(){
    return confirm('คุณต้องการที่จะลบข้อมูลหนังสือ ?');
}
</script>

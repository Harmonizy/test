...
<div class="container">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#">ระบบยืม-คืนหนังสือ หอสมุดกองทัพอากาศ</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item <?=$active_lend?>">
            <a class="nav-link" href="Searching/index.php#example">ค้นหาหนังสือ</a>
          </li>
          <li class="nav-item <?=$active_lend?>">
      ...
      <!-- orther -->
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item <?=$active_lend?>">
            ...
            <li class="nav-item <?=$active_lend?>">
              <a class="nav-link" href="lend.php">ดูข้อมูลหนังสือ</a>
            </li>
